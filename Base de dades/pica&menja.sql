...
CREATE TABLE restaurants (id_restaurant int AUTO_INCREMENT PRIMARY KEY, nom varchar(30) NOT NULL, telefon varchar(27) NOT NULL, pagina_web varchar(100) NOT NULL, 
ubicacio varchar(100) NOT NULL, horari_ca varchar(150) NOT NULL, horari_es varchar(150) NOT NULL, horari_en varchar(150) NOT NULL, horari_de varchar(150) NOT NULL, 
descripcio_ca text NOT NULL, descripcio_es text NOT NULL, descripcio_en text NOT NULL, descripcio_de text NOT NULL, imatge text, carta text, id_tipus int NOT NULL);
...
VALUES(
    ...
    "12:00-24:00. Miércoles cerrado. Cerrado temporalmente.",
    "12:15-15:30, 19:00-23:30. Miércoles cerrado.",
    "12:00-24:00. Wednesday closed. Temporarily closed.",
    "12:00-24:00. Mittwoch geschlossen. Vorübergehend geschlossen.",
...
VALUES(
    ...
    "10:30-23:30. Tancat temporalment.",
    "10:30-23:30. Cerrado temporalmente.",
    "10:30-23:30. Temporarily closed.",
    "10:30-23:30. Vorübergehend geschlossen.",
...
VALUES(
    ...
    "18:00-24:00. Dijous tancat. Tancat temporalment.",
    "18:00-24:00. Jueves cerrado. Cerrado temporalmente.",
    "18:00-24:00. Thursday closed. Temporarily closed.",
    "18:00-24:00. Donnerstag geschlossen. Vorübergehend geschlossen.",
...
VALUES(
    ...
    "19:00-24:00. Dilluns tancat. Tancat temporalment.",
    "19:00-24:00. Lunes cerrado. Cerrado temporalmente.",
    "19:00-24:00. Monday closed. Temporarily closed.",
    "19:00-24:00. Montag geschlossen. Vorübergehend geschlossen.",
...
VALUES(
    ...
    "Dilluns a diumenge 12.30-24.00. Tancat temporalment.",
    "Lunes a domingo 12:30-24:00. Cerrado temporalmente.",
    "Monday to Sunday 12:30-24:00. Temporarily closed.",
    "Montag bis Sonntag 12:30-24:00 Uhr. Vorübergehend geschlossen.",
