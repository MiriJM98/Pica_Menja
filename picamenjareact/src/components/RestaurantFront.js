...
export default class RestaurantFront extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.id_restaurant !== -1) {
            ...
            if (sessionStorage.getItem("id_idioma") === "2") {
                this.descarregaRestaurantEs(this.props.id_restaurant);
            }
            if (sessionStorage.getItem("id_idioma") === "3") {
                this.descarregaRestaurantEn(this.props.id_restaurant);
            }
            if (sessionStorage.getItem("id_idioma") === "4") {
                this.descarregaRestaurantDe(this.props.id_restaurant);
            }
        }
        if (this.props.id_restaurant !== -1) {
    ...
    descarregaRestaurantEs = (id_restaurant) => {
        const mostrador = document.getElementById("contingut");
        const divIframe = document.getElementById("iframeDiv");
        axios.get("http://localhost/PROJECTE_PICA_MENJA/Pica_Menja/PicaMenja/public/api/restaurants/" + id_restaurant)
            .then((response) => {
                ...
                let td_carta = document.createElement("td");
                // CONTINGUT
                let descripcio = document.createTextNode(response.data.descripcio_es);
                let imatgeDesc = document.createElement("img");
                let telefon = document.createTextNode(response.data.telefon);
                let imatgeTel = document.createElement("img");
                let horari = document.createTextNode(response.data.horari_es);
                let imatgeHorari = document.createElement("img");
                let pagina_web = document.createElement("a");
                pagina_web.text = response.data.pagina_web;
                pagina_web.href = response.data.pagina_web;
                ...
                let ubicacio = document.createTextNode(response.data.ubicacio);
                let imatgeUbi = document.createElement("img");
                let tipus = document.createTextNode(response.data.tipus.tipus_es);
                let imatgeTipus = document.createElement("img");
                let rang = document.createTextNode(response.data.rang_preus);
                let imatgeRang = document.createElement("img");
                let iframe = document.createElement("iframe");
    ...
    descarregaRestaurantEn = (id_restaurant) => {
        const mostrador = document.getElementById("contingut");
        const divIframe = document.getElementById("iframeDiv");
        axios.get("http://localhost/PROJECTE_PICA_MENJA/Pica_Menja/PicaMenja/public/api/restaurants/" + id_restaurant)
            .then((response) => {
                ...
                let td_carta = document.createElement("td");
                // CONTINGUT
                let descripcio = document.createTextNode(response.data.descripcio_en);
                let imatgeDesc = document.createElement("img");
                let telefon = document.createTextNode(response.data.telefon);
                let imatgeTel = document.createElement("img");
                let horari = document.createTextNode(response.data.horari_en);
                let imatgeHorari = document.createElement("img");
                let pagina_web = document.createElement("a");
                pagina_web.text = response.data.pagina_web;
                pagina_web.href = response.data.pagina_web;
                ...
                let ubicacio = document.createTextNode(response.data.ubicacio);
                let imatgeUbi = document.createElement("img");
                let tipus = document.createTextNode(response.data.tipus.tipus_en);
                let imatgeTipus = document.createElement("img");
                let rang = document.createTextNode(response.data.rang_preus);
                let imatgeRang = document.createElement("img");
                let iframe = document.createElement("iframe");
    ...
    descarregaRestaurantDe = (id_restaurant) => {
        const mostrador = document.getElementById("contingut");
        const divIframe = document.getElementById("iframeDiv");
        axios.get("http://localhost/PROJECTE_PICA_MENJA/Pica_Menja/PicaMenja/public/api/restaurants/" + id_restaurant)
            .then((response) => {
                ...
                let td_carta = document.createElement("td");
                // CONTINGUT
                let descripcio = document.createTextNode(response.data.descripcio_de);
                let imatgeDesc = document.createElement("img");
                let telefon = document.createTextNode(response.data.telefon);
                let imatgeTel = document.createElement("img");
                let horari = document.createTextNode(response.data.horari_de);
                let imatgeHorari = document.createElement("img");
                let pagina_web = document.createElement("a");
                pagina_web.text = response.data.pagina_web;
                pagina_web.href = response.data.pagina_web;
                ...
                let ubicacio = document.createTextNode(response.data.ubicacio);
                let imatgeUbi = document.createElement("img");
                let tipus = document.createTextNode(response.data.tipus.tipus_de);
                let imatgeTipus = document.createElement("img");
                let rang = document.createTextNode(response.data.rang_preus);
                let imatgeRang = document.createElement("img");
                let iframe = document.createElement("iframe");
